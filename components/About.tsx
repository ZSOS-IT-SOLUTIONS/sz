...
const About: React.FC = () => {
  return (
    <div className="animate-fade-in bg-bg-light min-h-screen pb-20">
      ...
      {/* Header Section */}
      <section className="bg-primary py-12 md:py-20 px-6 text-center text-white rounded-b-[40px] mb-16 shadow-soft">
        <h1 className="text-3xl md:text-5xl font-extrabold font-montserrat mb-4">About Us</h1>
      ...
      <div className="container mx-auto px-4 max-w-6xl space-y-24">
        ...
        <section className="bg-white rounded-3xl p-8 md:p-12 shadow-lg">
          <h2 className="text-2xl md:text-4xl font-bold text-primary mb-6 font-montserrat text-center">Our Vision & Mission</h2>
        ...
        {/* Mastermind Section */}
        <section id="team" className="py-12 md:py-16 px-4 md:px-8 bg-white dark:bg-card-dark transition-colors duration-300">
          <div className="max-w-[1100px] mx-auto flex flex-col-reverse md:flex-row items-center justify-center gap-8 md:gap-24 p-6 md:p-8 rounded-[40px] border border-gray-100 dark:border-gray-700 shadow-xl bg-gradient-to-br from-white to-purple-50/50 dark:from-card-dark dark:to-gray-900">

            {/* Text Column */}
            <div className="flex-1 text-center md:text-left min-w-0 w-full">
              <h2 className="text-3xl md:text-5xl font-bold text-[#6a44c9] dark:text-[#a78bfa] mb-4 md:mb-6 font-montserrat leading-tight md:whitespace-nowrap">
                The Mastermind Behind Us
              </h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6 font-medium text-base md:text-lg">
              ...
              <div className="flex flex-wrap gap-4 md:gap-6 justify-center md:justify-start">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="hover-trigger flex items-center gap-2 text-gray-700 dark:text-gray-200 font-bold hover:text-[#0A66C2] dark:hover:text-[#4d9be2] transition-colors text-sm md:text-base"
                >
                  <img
                ...
                <a
                  ...
                  className="hover-trigger flex items-center gap-2 text-gray-700 dark:text-gray-200 font-bold hover:text-green-600 transition-colors text-sm md:text-base"
                >
            ...
            {/* Image Column */}
            <div className="flex flex-col items-center shrink-0 w-full md:w-auto md:ml-16">
              <a href="https://profilecard.skyzuri.com" target="_blank" rel="noopener noreferrer" className="block transform hover:scale-105 transition-transform duration-300">
                <div className="relative w-[220px] h-[220px] sm:w-[350px] sm:h-[350px] flex items-center justify-center">
                  {/* Image */}
                  <img
                    src="images/skz.png"
                    alt="Ibrahim - CEO"
                    className="w-full h-full object-cover cursor-pointer rounded-full shadow-lg border-4 border-white/20"
                  />
                </div>
              </a>

              <div className="text-center mt-6">
                <a href="https://profilecard.skyzuri.com" target="_blank" rel="noopener noreferrer" className="text-lg md:text-xl font-bold text-gray-900 dark:text-white font-montserrat hover:underline">
                  Mohamed Murshal Ibrahim T
                </a>
                <p className="text-gray-500 dark:text-gray-400 font-medium text-sm md:text-base">Founder & CEO, SkyZuri Techbridge</p>
              </div>
            </div>
        ...
        <section>
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-primary font-montserrat">Accreditations & Certifications</h2>
        ...
        <section>
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-4xl font-bold text-primary font-montserrat">Our Collaborators</h2>
