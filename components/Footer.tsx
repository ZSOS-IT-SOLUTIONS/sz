...
const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  ...
  return (
    <motion.footer
      className="bg-gray-900 text-white pt-10 md:pt-16 pb-8"
          ...
          <div className="flex-grow flex flex-wrap justify-center md:justify-end gap-10">
            ...
            <div className="min-w-[150px] text-center md:text-left">
              ...
              <ul className="space-y-3">
                <li><motion.button onClick={() => handleLinkClick('home')} className="text-base text-white" whileHover={{ scale: 1.1, color: '#00A8E8' }}>Home</motion.button></li>
                <li><motion.button onClick={() => handleLinkClick('about')} className="text-base text-white" whileHover={{ scale: 1.1, color: '#00A8E8' }}>About Us</motion.button></li>
                <li><motion.button onClick={() => handleLinkClick('services')} className="text-base text-white" whileHover={{ scale: 1.1, color: '#00A8E8' }}>Services</motion.button></li>
                <li><motion.button onClick={() => handleLinkClick('portfolio')} className="text-base text-white" whileHover={{ scale: 1.1, color: '#00A8E8' }}>Portfolio</motion.button></li>
            ...
            <div className="min-w-[150px] text-center md:text-left">
              ...
              <ul className="space-y-3">
                <li><motion.button onClick={() => handleLinkClick('team')} className="text-base text-white" whileHover={{ scale: 1.1, color: '#00A8E8' }}>Team</motion.button></li>
                <li><motion.button onClick={() => handleLinkClick('careers')} className="text-base text-white" whileHover={{ scale: 1.1, color: '#00A8E8' }}>Careers</motion.button></li>
              </ul>
            </div>
            ...
            <div className="min-w-[150px] text-center md:text-left">
              ...
              <ul className="space-y-3">
                <li><motion.button onClick={() => handleLinkClick('support')} className="text-base text-white" whileHover={{ scale: 1.1, color: '#00A8E8' }}>Support</motion.button></li>
